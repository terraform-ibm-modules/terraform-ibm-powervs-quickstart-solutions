...
locals {
  ...
  qs_tshirt_choice = lookup(local.ibm_powervsi_tshirt_sizes, var.tshirt_size, null)
  ...
  pi_instance = {
    pi_image_id             = lookup(module.powervs_vpc_landing_zone.powervs_images, local.qs_tshirt_choice.image, null)
    pi_networks             = [module.powervs_vpc_landing_zone.powervs_management_subnet, module.powervs_vpc_landing_zone.powervs_backup_subnet]
