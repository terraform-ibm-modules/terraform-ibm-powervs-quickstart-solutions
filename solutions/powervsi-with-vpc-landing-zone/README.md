# IBM Cloud Solution for PowerVS Instance with VPC Landing Zone - PowerVS Instance Variation
...
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
| [PowerVS Instance](./)    | :heavy_check_mark:  |   N/A  | :heavy_check_mark:| :heavy_check_mark: | :heavy_check_mark:  | :heavy_check_mark: | N/A |
...
| <a name="module_powervs_vpc_landing_zone"></a> [powervs\_vpc\_landing\_zone](#module\_powervs\_vpc\_landing\_zone) | git::https://github.com/terraform-ibm-modules/terraform-ibm-powervs-infrastructure//modules/powervs-vpc-landing-zone | new_architecture |
