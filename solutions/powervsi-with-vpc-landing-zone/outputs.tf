...
output "vpc_names" {
  ...
  value       = module.powervs_vpc_landing_zone.vpc_names
}

output "vsi_names" {
  description = "A list of the vsis names provisioned within the VPCs."
  value       = module.powervs_vpc_landing_zone.vsi_names
}
...
output "transit_gateway_name" {
  ...
  value       = module.powervs_vpc_landing_zone.transit_gateway_name
}

output "transit_gateway_id" {
  description = "The ID of transit gateway."
  value       = module.powervs_vpc_landing_zone.transit_gateway_id
}
...
output "proxy_host_or_ip_port" {
  ...
  value       = module.powervs_vpc_landing_zone.proxy_host_or_ip_port
}

output "dns_host_or_ip" {
  description = "DNS forwarder host for created PowerVS infrastructure."
  value       = module.powervs_vpc_landing_zone.dns_host_or_ip
}

output "ntp_host_or_ip" {
  description = "NTP host for created PowerVS infrastructure."
  value       = module.powervs_vpc_landing_zone.ntp_host_or_ip
}
...
output "powervs_workspace_name" {
  ...
  value       = module.powervs_vpc_landing_zone.powervs_workspace_name
}
...
output "powervs_management_subnet" {
  ...
  value       = module.powervs_vpc_landing_zone.powervs_management_subnet
}

output "powervs_backup_subnet" {
  description = "Name, ID and CIDR of backup private network in created PowerVS infrastructure."
  value       = module.powervs_vpc_landing_zone.powervs_backup_subnet
}
